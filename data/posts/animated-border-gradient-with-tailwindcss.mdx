...
I'm going to use a pre-made Tailwind CSS gradient from [Hypercolor](https://hypercolor.dev/). We apply the gradient to the interactive element with the fake border.
