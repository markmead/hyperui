...
You can use `hover:animate-border` if preferred, but note that it will reset the animation when you are no longer on hover, this can cause it to look a little jumpy.
