...
description: This guide will show you how to eliminate the spinners that appear on number inputs using Tailwind CSS and CSS techniques.
...
This integrates the `no-spinner` class into Tailwind CSS. It will show up in Tailwind CSS Intellisense in VS Code.
