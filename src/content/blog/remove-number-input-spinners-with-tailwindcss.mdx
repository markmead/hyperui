...
description: This guide will show you how to eliminate the spinners that appear on number
  inputs using Tailwind CSS.
slug: remove-number-input-spinners-with-tailwindcss
emoji: 🎚️
pubDate: 12/05/2022
updatedDate: 12/05/2022
---
...
[quantity input component](/components/application/quantity-inputs#component-2).
