...
## What makes HyperUI different?

HyperUI focuses on simplicity over abstraction. There’s no setup, no lock-in, and no magic —
    just high-quality Tailwind CSS components you can copy, customize, and own forever.
