...
components:
  ...
  3:
    title: Gradient border, rounded-sm and pill
  4:
    title: Icon, solid and bordered
  5:
    title: Drop shadow, hide shadow-sm and show shadow-sm on hover
  6:
    title: Base with icon on hover, solid, bordered and icon left/right
  7:
    title: Base with shadow-sm and expand on hover, solid and bordered
  8:
