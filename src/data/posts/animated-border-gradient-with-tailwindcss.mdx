...
<a
  href="#"
  class="animate-background inline-block bg-white from-pink-500 via-red-500 to-yellow-500 bg-[length:400%_400%] p-0.5 [animation-duration:_6s] hover:bg-gradient-to-r"
>
  <span class="block bg-slate-900 px-5 py-3 text-white"> Get Started </span>
</a>
```
...
<Preview
  ...
  previewContainer="grid min-h-screen place-content-center bg-gray-900 p-8"
/>
