...
Boom! HTML cleaned up. However, what if we are using classes that cannot be delegated to the parent?
...
_If you a believe Tailwind CSS is "inline styles" then this should really fuel that **pointless** anger._
...
This might look like confusing but it's quite simple as `[&>*]` is just CSS. It's the same as writing this.
...
If you're unsure what this is doing it translates to.
...
It's more of an opinion, I initially arbitrary classes looked messy, but when used correctly they can really help clean up your Tailwind CSS code.
