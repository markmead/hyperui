---
title: Create a Progress Bar with a Single HTML Element (v3)
description: Learn how to create a progress bar using Tailwind CSS and a single HTML element.
date: 04/20/2023
emoji: 💈
---

In April 2023, I added new [progress bar components](/components/application/progress) to HyperUI and it led me to ponder:
...
This example showcases the [simple progress bar](/components/application/progress#component-1) component.
...
But, if you were to design something like the [striped progress bar](/components/application/progress#component-5) component, the single element approach wouldn't result in clean code. Your `class="..."` would become a jumble of text that's hard to read.
