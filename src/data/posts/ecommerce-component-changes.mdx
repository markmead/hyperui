...
Based on the results from the poll (and partially the lack of engagement in this boring subject) I took it that the majority are OK with this. Therefore, going forward on HyperUI there will be no eCommerce category and the components have been moved into the relative category.
