...
Now, you can write `text-shadow shadow-red-500` and a beautiful red text shadow will appear, created with Tailwind CSS and no custom CSS.
...
You can add as many as you like. Here's how they look.
