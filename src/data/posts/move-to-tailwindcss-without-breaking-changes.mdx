---
title: Moving to Tailwind CSS v4 from another framework? Use a Prefix!
description: Migrating to Tailwind CSS v4 from another CSS framework? Here’s a simple solution to avoid class conflicts.
...
Whether you're moving from Bootstrap, Bulma, or any other CSS framework, Tailwind CSS v4 makes it easy to avoid class name conflicts.
