    ...
    <div ref={refDropdown} className="relative flex h-16 max-w-[300px] flex-1 items-center">
      <form role="search" className="flex-1">
        ...
        <input
          ...
          placeholder="Search..."
          id="SiteSearch"
          className="w-full rounded-md border-gray-200 bg-white sm:text-sm dark:border-gray-700 dark:bg-gray-800"
        />
      ...
      {showDropdown && (
        <div className="absolute inset-x-0 top-14 z-50 rounded-md border border-gray-100 bg-white shadow-lg dark:border-gray-800 dark:bg-gray-900">
              ...
              {searchResults.map((searchResult) => (
                <li key={searchResult.id}>
                  <Link
                    ...
                    className="flex items-center justify-between rounded-md px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 focus:bg-gray-50 dark:text-gray-200 dark:hover:bg-gray-800 dark:focus:bg-gray-950"
                  >
                    <span>{searchResult.title}</span>

                    <span className="block rounded bg-gray-200 px-1.5 py-0.5 text-xs text-gray-900 dark:bg-gray-700 dark:text-white">
