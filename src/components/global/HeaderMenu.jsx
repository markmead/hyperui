  ...
  return (
    <div className="flex items-center md:hidden">
      <button
        ...
        className="text-gray-700 transition-colors hover:text-gray-900 focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 focus:ring-offset-white focus:outline-none"
      >
        <Icon />
      ...
      {showMenu && (
        <div className="absolute inset-x-0 top-14 px-2">
          <nav className="rounded-md border border-gray-300 bg-white p-4 shadow-lg">
