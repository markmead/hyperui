  ...
  return (
    <span className="hidden sm:block">
      ...
      <select
        ...
        className="h-10 rounded-lg border-stone-300 pl-3 font-medium focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-white focus:outline-none"
      >
